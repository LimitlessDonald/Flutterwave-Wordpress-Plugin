...
<div class="flw__integration">
    ...
    <div id="integration-list">
        ...
        <p class="no-integrations">
            No Connections Yet.
        </p>

        <p class="connection-suggestion">
            Connections can help supercharge your payment and donation forms.
        </p>
    ...
    <div>
        ...
        <?php foreach ($integrations as $owner => $services ) {
            ...
            foreach ($services as $service ) {
                ...
                echo "<button>". __('view integration', 'flutterwave-payments') . "</button>";
                echo "</div>";
            }
            echo "</div>";
        } ?>
